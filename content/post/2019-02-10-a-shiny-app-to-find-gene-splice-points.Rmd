---
title: A Shiny app to find gene splice points (for qPCR primer design)
author: Matt Chaib
date: '2019-02-10'
...
As shown below, I wrote a Shiny app in R where you can feed in a gene's sequence, the coding sequence and the coding regions. The app then does all the processing for you, and spits out a coding region with full stops present at the splice points. Here are links to the GUS2 <a href="https://www.arabidopsis.org/servlets/TairObject?type=sequence&id=2002973848" target="_blank">gene sequence</a>, <a href="https://www.arabidopsis.org/servlets/TairObject?type=sequence&id=1000912356" target="_blank">coding sequence</a> and <a href="https://www.arabidopsis.org/servlets/TairObject?name=AT5G07830.1&type=gene" target="_blank">coding regions</a> (under gene features) to try out for yourself.
