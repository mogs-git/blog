...
As shown below, I wrote a Shiny app in R where you can feed in a gene's sequence, the coding sequence and the coding regions. The app then does all the processing for you, and spits out a coding region with full stops present at the splice points. Here is are links to the GUS2 [gene sequence](https://www.arabidopsis.org/servlets/TairObject?type=sequence&id=2002973848), [coding sequence](https://www.arabidopsis.org/servlets/TairObject?type=sequence&id=1000912356) and [coding regions](https://www.arabidopsis.org/servlets/TairObject?name=AT5G07830.1&type=gene) (under gene features) to try out for yourself.
