...
One can see, we are already building up the backbone of our analysis. To make thing clearer, here is a diagram:
...
knitr::include_graphics("../eu_hansard/drawings/hans_names.png")
```
