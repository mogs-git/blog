...
In the house of Lords, each speakers name is prefixed by a title- Lord, Baroness, Lady, etc... From this we can infer the gender of the MP. We can also extract their party (provided next to their title). If we wanted to, we could even search for external metadata such as age, or Alma Mater, but for now we will stick exclusively to what we can gleen from the Hansard itself. 
